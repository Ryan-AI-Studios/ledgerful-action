    ...
    steps:
      ...
      - name: Run Ledgerful PR risk scan
        ...
        with:
          ...
          # checksum for ledgerful-x86_64-unknown-linux-gnu.tar.gz (v0.2.14); substitute for other OS/arch
          ledgerful-checksum: 2b1ac064a2db39b17c0dda4a88505930f91a8ab69af00cd8c42225c1bda8f9f1
        env:
...
| --- | --- | --- | --- |
| `ledgerful-version` | no | `v0.2.14` | pinned engine release version |
